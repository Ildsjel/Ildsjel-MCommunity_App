      ...
      <Box sx={{ maxWidth: 480, mx: 'auto', px: 2, pt: 2, pb: 12 }}>
        ...
        {error && (
          <Box sx={{ border: '1.5px solid rgba(196,58,42,0.4)', borderRadius: '3px', p: '10px 12px', mb: 2, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <span style={{ ...mono, fontSize: '0.625rem', letterSpacing: '0.1em', color: 'var(--accent)' }}>✕ {error}</span>
        ...
        {/* Status */}
        <Box sx={sectionBox}>
          <span style={{ ...mono, fontSize: '0.6875rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--muted)', display: 'block', marginBottom: 14 }}>
            Status
          </span>
          ...
          {status?.is_connected ? (
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
              ...
              {(status.total_artists || 0) > 0 && (
                <span style={{ ...mono, fontSize: '0.5625rem', letterSpacing: '0.08em', color: 'var(--muted)' }}>

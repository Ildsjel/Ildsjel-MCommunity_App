...
class AdminRepository:
    ...
    def create_token(self, created_by_id: str, note: Optional[str] = None) -> dict:
    ...
    def get_tokens(self, created_by_id: str) -> List[dict]:
    ...
    def redeem_token(self, token_val: str, user_id: str) -> Optional[dict]:
